...
import largesvg2 from "./largeSvg2.svg";
import largesvg3 from "./largeSvg3.svg";
import largesvg4 from "./largeSvg4.svg";
import largesvg5 from "./largeSvg5.svg";
import largesvg6 from "./largeSvg6.svg";
...
const MentorSection = () => {
  ...
  const backGroundColors = ["#FFF8F1", "#E8FFF9", "#EEF7FF"];
  ...
  return (
    <>
      ...
      <div className="mentor-section-desktop-nav-and-background">
        <Background />
        <DesktopNavbar />
      </div>
      <div className="mentor-desktop-main-wrapper">
        <div className="mentor-desktop-main-content-section">
